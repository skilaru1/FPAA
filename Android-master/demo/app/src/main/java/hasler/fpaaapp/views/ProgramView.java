...
/*----------------------------------MAIN_APP_VIEW-----------------------------------*/
/*----------------------------------------------------------------------------------*/
public class ProgramView extends DriverFragment {
    ...
    //initialize View
    public static ProgramView newInstance() {
        return new ProgramView();
    }

    public ProgramView() { /* Required empty public constructor */ }
...
/*----------------------------------------------------------------------------------*/
    ...
    */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragment_programview, container, false);
        ...
        zipAddress.setText("https://github.com/caustin4815/FPAADesigns/blob/master/");
        ...
        zipFileLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                url = Configuration.rootGitLoc + addressString + Configuration.gitZipURLParams;
            }
        });
            ...
            public void onClick(View v) {
                new ThreadRunnable() {
                    ...
                    public Boolean doInBackground(Void... params) {
                        ...
                        if (!compileAndProgram(zipped_files, "tunnel_revtun_SWC_CAB.elf", 10 * 1000)) return false;
                        ...
                        if (!compileAndProgram(zipped_files, "switch_program.elf", 70 * 1000)) return false;
